...
export default function HomePage({ onNavigate }: Props) {
  ...
  const games = [
    ...
    { id: 'slot1', name: 'Слот Классик', emoji: '🎰', desc: '3 барабана, 8 символов. Классика на все времена.', tag: 'Удача' },
    { id: 'slot2', name: 'Слот Фрукты', emoji: '🍒', desc: '5 барабанов, 3 линии. Фруктовый рай с крупными выплатами.', tag: 'Мега' },
  ];
